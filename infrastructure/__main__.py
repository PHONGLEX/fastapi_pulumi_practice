...
cluster_name = "fastapi-authentication-ecs-cluster"
user_data='''#!/bin/bash
...
task_def = aws.ecs.TaskDefinition(
    ...
    container_definitions=json.dumps([{
		"name": "my-app",
		"image": "134477770615.dkr.ecr.us-east-2.amazonaws.com/fastapi-repo-db6dd1e:a02200950ac8c0b7641965b948899fd96b98dd6d7574cf0630bbf12cece2ce88", # a simple nginx example
		"portMappings": [{
			"containerPort": 8000,
			"hostPort": 80,
			"protocol": "tcp"
